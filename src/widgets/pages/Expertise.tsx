...
const analysisImg = require('../../assets/images/services/analysis.png');
const designImg = require('../../assets/images/services/design.png');
const managementImg = require('../../assets/images/services/management.png');
