...
const analysisImg = require('../../assets/images/services/analysis.jpg');
const designImg = require('../../assets/images/services/design.jpg');
const managementImg = require('../../assets/images/services/management.jpg');
