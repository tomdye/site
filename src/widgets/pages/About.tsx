...
export const About = factory(function About() {
	return (
		<div classes={css.root}>
			<head>
				<title>About SitePen - A Leading Web App Development Company</title>
				<meta
					name="description"
					content="Learn more about SitePen, a leading web engineering consultancy based in the US with more than two decades of experience developing enterprise-grade solutions."
				/>
				...
				<meta
					...
					content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
				/>
				<link rel="canonical" href="https://www.sitepen.com/about-us/" />
				<meta property="og:locale" content="en_US" />
				<meta property="og:type" content="article" />
				<meta
					property="og:title"
					content="About SitePen - A Leading Web App Development Company"
				/>
				<meta
					property="og:description"
					content="Learn more about SitePen, a leading web engineering consultancy based in the US with more than two decades of experience developing enterprise-grade solutions."
				/>
				<meta property="og:url" content="https://www.sitepen.com/about-us/" />
