...
export const CaseStudyBuilt = factory(function CaseStudyBuilt() {
	return (
		<div classes={css.root}>
			<head>
				<title>Custom Web Application: Built Technologies | SitePen</title>
				<meta
					name="description"
					content="Learn how we helped Built Technologies improve their enterprise-level software solution and accelerate key capabilities for their users."
				/>
				...
				<link
					rel="canonical"
					href="https://www.sitepen.com/case-study/built-technologies/"
				/>
				<meta property="og:locale" content="en_US" />
				<meta property="og:type" content="article" />
				<meta
					property="og:title"
					content="Custom Web Application: Built Technologies | SitePen"
				/>
				<meta
				...
				<meta
					property="og:url"
					content="https://www.sitepen.com/case-study/built-technologies/"
				/>
